...
public class GameReel : MonoBehaviour
{
	...
	private void GenerateActiveDummies(List<SymbolData> existingSelections)
	{
		...
		bottomDummySymbols = SpawnDummySymbols(symbolRoot, true, bottomCount, true, existingSelections);
		topDummySymbols = SpawnDummySymbols(symbolRoot, false, topCount, true, existingSelections);
	...
	private void SpawnNextReel(List<SymbolData> solution = null)
	{
		...
		bufferBottomDummySymbols = SpawnDummySymbols(nextSymbolsRoot, true, bottomCount, false, combinedExisting);
		bufferTopDummySymbols = SpawnDummySymbols(nextSymbolsRoot, false, topCount, false, combinedExisting);
	}
